...
export function Flag({ width, className }: { width: number; className?: string }) {
  return (
    <div className={`${className} ${classes.outline}`}>
      <svg xmlns="http://www.w3.org/2000/svg" width={width} viewBox="-72 -48 144 96">
